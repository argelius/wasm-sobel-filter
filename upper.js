...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'upper.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'upper.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'upper.temp.asm.js';
...
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "upper.js.mem" : null;
...
var real__upper = asm["_upper"]; asm["_upper"] = function() {
assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
return real__upper.apply(null, arguments);
};
...
var _upper = Module["_upper"] = function() { return Module["asm"]["_upper"].apply(null, arguments) };
